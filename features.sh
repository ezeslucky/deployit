...
update_deployi() {
    ...
    docker pull deployi:deployi:feature

    # Update the service
    docker service update --image deployi:deployi:feature deployi

    echo "Deployi has been updated to the latest feature version."
}
