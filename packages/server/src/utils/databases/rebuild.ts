...
import { deployMariadb } from "@deployi/server/services/mariadb";
import { deployMongo } from "@deployi/server/services/mongo";
import { deployMySql } from "@deployi/server/services/mysql";
import { deployPostgres } from "@deployi/server/services/postgres";
import { deployRedis } from "@deployi/server/services/redis";
