...
export function generateStaticParams() { 
  return Promise.resolve(
    [{"slug":["build-failed"]},{"slug":["build-success"]},{"slug":["database-backup"]},{"slug":["deployi-restart"]},{"slug":["docker-cleanup"]},{"slug":["invitation"]},{"slug":["notion-magic-link"]},{"slug":["plaid-verify-identity"]},{"slug":["stripe-welcome"]},{"slug":["vercel-invite-user"]}]
  );
}