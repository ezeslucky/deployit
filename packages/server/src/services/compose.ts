...
import { paths } from "@deployi/server/constants";
import { db } from "@deployi/server/db";
import { type apiCreateCompose, compose } from "@deployi/server/db/schema";
import { buildAppName, cleanAppName } from "@deployi/server/db/schema";
import {
	buildCompose,
	getBuildComposeCommand,
} from "@deployi/server/utils/builders/compose";
import { randomizeSpecificationFile } from "@deployi/server/utils/docker/compose";
import {
	cloneCompose,
	cloneComposeRemote,
	loadDockerCompose,
	loadDockerComposeRemote,
} from "@deployi/server/utils/docker/domain";
import type { ComposeSpecification } from "@deployi/server/utils/docker/types";
import { sendBuildErrorNotifications } from "@deployi/server/utils/notifications/build-error";
import { sendBuildSuccessNotifications } from "@deployi/server/utils/notifications/build-success";
import {
	execAsync,
	execAsyncRemote,
} from "@deployi/server/utils/process/execAsync";
import {
	cloneBitbucketRepository,
	getBitbucketCloneCommand,
} from "@deployi/server/utils/providers/bitbucket";
import {
	cloneGitRepository,
	getCustomGitCloneCommand,
} from "@deployi/server/utils/providers/git";
import {
	cloneGiteaRepository,
	getGiteaCloneCommand,
} from "@deployi/server/utils/providers/gitea";
import {
	cloneGithubRepository,
	getGithubCloneCommand,
} from "@deployi/server/utils/providers/github";
import {
	cloneGitlabRepository,
	getGitlabCloneCommand,
} from "@deployi/server/utils/providers/gitlab";
import {
	createComposeFile,
	getCreateComposeFileCommand,
} from "@deployi/server/utils/providers/raw";
