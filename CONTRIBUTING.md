...
```bash
git clone https://github.com/ezeslucky/deployit.git.git
cd deployit
pnpm install
cp apps/deployit/.env.example apps/deployit/.env
```
...
To add a new template, go to `https://github.com/deployit/templates` repository and read the README.md file.
...
To contribute to the deployit docs or website, please go to this [repository](https://github.com/deployit/website).
