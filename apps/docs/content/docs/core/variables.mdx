...
description: "deployit allows you to create and manage shared environment variables for your projects."
---
...
<Callout type="info">
  deployit will automatically replace `${{project.DATABASE_URL}}` with the value defined in the project's shared variables.
</Callout>
...
You can use shared enviroment variables in all the services available in deployit.