---
title: Monitoring
description: "Monitor your applications and servers with deployit"
---
...
- **Metrics Callback URL**: The endpoint that receives metrics data. Default URL is:
  ```
  https://app.deployit.com/api/trpc/notification.receiveNotification
  ```
...
This is feature only available on Cloud Version of deployit.
