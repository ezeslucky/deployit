---
title: Domains
description: This section outlines how to configure domains for your applications in deployit, ensuring that your applications are accessible via custom URLs.
---

import { Callout } from 'fumadocs-ui/components/callout';
import { Link } from 'next/link';

deployit Provide 2 ways to add a domain to your service:
...
If you don't have a domain, you can use our integrated free domains from Traefik.me in the deployit panel, without doing any configuration however is only for HTTP, if you want to have a HTTPS domain you need to buy a domain from one of the providers above.
