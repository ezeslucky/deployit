...
If you wish to customize the deployit installation on your server, you can modify several enviroment variables:
...
5. **RELEASE_TAG** - Set to a deployit docker hub tag(latest, canary, feature, etc)
