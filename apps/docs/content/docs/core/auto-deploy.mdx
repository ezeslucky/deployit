---
title: Auto Deploy
description: Automatically deploying your application to deployit can be achieved through two primary methods using Webhooks or the deployit API. Each method supports various platforms and provides a streamlined deployment process.
---
...
Deploy your application programmatically using the deployit API from anywhere, this is useful when you want to trigger a deployment from a CI/CD pipeline or from a script.
