---
title: MariaDB
description: This guide will cover how to connect from Beekeeper Studio to your mariadb databases in deployit.
---
...
3. Use `Import URL` to enter the `External Connection URL` from deployit eg. `mysql://user:password@1.2.4.5:3306/database`.
4. Click on `Connect`.
5. Click on `Save`.
