---
title: Security
description: "Security features of deployit"
---

deployit provides comprehensive security recommendations to protect your remote server. Our security checks ensure your server follows best practices for a secure deployment environment.
...
deployit automatically validates these security configurations and provides recommendations:
