...
Email notifications are a great way to stay up to date with important events in your deployit panel. You can choose to receive notifications for specific events or all events.
