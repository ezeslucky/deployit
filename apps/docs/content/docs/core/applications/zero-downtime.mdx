---
title: Zero Downtime
description: Learn how to configure zero downtime deployments in deployit.
---


deployit allows you to configure zero downtime deployments, which means that you can deploy your application without any downtime.
...
but deployit allows you to configure zero downtime deployments.
...
1. We will use this example [Github Repo](https://github.com/deployit/swarm-test)
2. It Have a endpoint called `health` [endpoint](https://github.com/deployit/swarm-test/blob/main/index.js#L20) which is the one that will tell us if our application is healthy.
...
1. **Use Git Provider in Your Application**:
   - Repository: `https://github.com/deployit/swarm-test`
   - Branch: `main`
   - Build path: `/`
