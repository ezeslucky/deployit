...
Applications in deployit are treated as a single service, entity or container, making it easy and intuitive for users to work with each application in its own workspace.
