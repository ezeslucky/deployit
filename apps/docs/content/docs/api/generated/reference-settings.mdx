...
_openapi:
  toc:
    ...
    - depth: 2
      title: Settings get deployit Version
      url: '#settings-get-deployit-version'
    - depth: 2
  ...
  structuredData:
    headings:
      ...
      - content: Settings get deployit Version
        id: settings-get-deployit-version
