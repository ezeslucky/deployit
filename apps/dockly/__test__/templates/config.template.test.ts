...
import type { CompleteTemplate } from "@dockly/server/templates/processors";
import { processTemplate } from "@dockly/server/templates/processors";
import type { Schema } from "@dockly/server/templates";
