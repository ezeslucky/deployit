import { generateRandomHash } from "@dockly/server";
import { addSuffixToAllVolumes, addSuffixToVolumesRoot } from "@dockly/server";
import type { ComposeSpecification } from "@dockly/server";
