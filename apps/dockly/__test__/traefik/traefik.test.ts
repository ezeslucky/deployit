import type { Domain } from "@dockly/server";
import type { Redirect } from "@dockly/server";
import type { ApplicationNested } from "@dockly/server";
import { createRouterConfig } from "@dockly/server";
