import type { Schema } from "@deployi/server/templates";
import type { CompleteTemplate } from "@deployi/server/templates/processors";
import { processTemplate } from "@deployi/server/templates/processors";
