# deployit Monitoring (Go Version)

Application that powers deployit's monitoring service.
...
deployit uses a callback URL to send notifications when metrics exceed configured thresholds. Notifications are sent via POST request in the following format:
