...
import type { IUpdateData } from "../../../../packages/server/src/index";
...
export const UpdateServerButton = () => {
    ...
    const {mutateAsync: getUpdateData} = api.settings.getUpdateData.useMutation()
...
<UpdateServer updateData={updateData} isOpen={isOpen} onOpenChange={setIsOpen}>
